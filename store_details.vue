                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div id="map" class="margin_20">
                              ...
                              <mapplic-png-map ref="pngmap_ref" :height="314" :hovertip="true" :storelist="processedStores" :floorlist="floorList" :svgWidth="1500" :svgHeight="1500" @updateMap="updatePNGMap" id="store_details_map"></mapplic-png-map>  
                            </div>
